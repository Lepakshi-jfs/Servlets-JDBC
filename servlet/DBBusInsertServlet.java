...
@WebServlet("/dbbusinsert")
public class DBBusInsertServlet extends HttpServlet {
...
protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	...
	{
		busNumber = Integer.parseInt(request.getParameter("busNumber"));
	}
	else {
	...
	RequestDispatcher requestDispatcher = request.getRequestDispatcher("dbbusselect");
